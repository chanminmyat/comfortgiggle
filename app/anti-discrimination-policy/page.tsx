          ...
          <div className='max-w-3xl mx-auto'>
            ...
            <div className='space-y-8 text-gray-700'>
              ...
              <section className='space-y-3'>
                ...
                <p>
                  Discrimination based on race, color, religion, gender, gender
                  identity, sexual orientation, national origin, genetics,
              ...
              <section className='space-y-3'>
                ...
                <ul className='space-y-2'>
                  <li>
                    Refusal of Service: Freelancers may not decline a consult
                    based on a client’s membership in a protected class.
                  </li>
                  <li>
                    Harassment: Any form of slurs, hate speech, or harassment
                    during a virtual consult or in chat will result in immediate
              ...
              <section className='space-y-3'>
                ...
                <p>
                  For questions regarding any of these policies, please contact
                  us:
                </p>
