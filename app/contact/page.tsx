      ...
      <main className="flex-1">
        <section className="relative h-[300px] flex items-center justify-center overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: 'url(https://images.pexels.com/photos/1660195/pexels-photo-1660195.jpeg?auto=compress&cs=tinysrgb&w=1920)',
            }}
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Have a question about our products or services? Fill out the form below and our team will get back to you within 24 hours.
                </p>
